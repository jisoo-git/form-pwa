...
export const FALLBACK_POSTS: Post[] = [
  {
    ...
    content: [
      { type: 'text', text: '디미고(한국디지털미디어고등학교)는 IT 특성화고 중 최고 명문으로 꼽힙니다. 전국 단일 학교로 전기학교로 분류되며, 전국 어디서나 지원 가능합니다.' },
      { type: 'text', text: '디미고 입시는 크게 두 가지 전형으로 나뉩니다. 특별전형(이하 특전)과 일반전형(이하 일전)입니다.' },
      { type: 'text', text: '특전은 방과후학교 실적물을 제출하고 서류 심사와 면접으로 평가받습니다. IT 관련 프로젝트나 코딩 활동 경험이 있는 학생에게 유리합니다.' },
      { type: 'text', text: '일전은 소질적성검사를 통해 평가합니다. C언어, 정보소양, 논리적 사고 세 영역을 시험으로 측정하며, 코딩을 처음 시작하는 학생도 준비할 수 있습니다.' },
      { type: 'text', text: '어떤 전형이 맞는지 모르겠다면 상담을 먼저 받아보시길 권장합니다. 학생의 현재 수준과 목표에 따라 전략이 달라집니다.' },
    ],
  },
  {
    id: 'post-2',
    ...
    content: [
      { type: 'text', text: '특별전형에서 실적물은 당락을 결정하는 핵심 요소입니다. 단순한 코딩 결과물보다는 "왜 이 프로젝트를 했는가"에 대한 스토리가 중요합니다.' },
      { type: 'text', text: '좋은 실적물은 세 가지 요소를 갖춰야 합니다. 첫째, 창의적인 아이디어. 둘째, 구현 가능성이 있는 코드. 셋째, 명확한 문제 해결 의도.' },
      { type: 'text', text: '실적물 주제는 7월에 결정하고 8월 내에 완성하는 것이 이상적입니다. 9월 이후에는 이론 학습과 면접 준비에 집중해야 합니다.' },
      { type: 'text', text: '인코딩플러스에서는 7월부터 실적물 주제 선정을 함께하고, 매주 토요일 6시간 수업을 통해 완성도를 높여나갑니다.' },
    ],
  },
  {
    id: 'post-3',
    ...
    content: [
      { type: 'text', text: '소질적성검사는 일반전형 지원자라면 반드시 통과해야 하는 관문입니다. 매년 10월에 시행되며 세 영역을 평가합니다.' },
      { type: 'text', text: 'C언어 영역에서는 기본 문법과 알고리즘 문제가 출제됩니다. for/while 반복문, 조건문, 배열, 함수를 중점적으로 학습해야 합니다.' },
      { type: 'text', text: '정보소양은 컴퓨터 기본 개념, 자료구조, 진법 변환 등을 다룹니다. 이론 암기보다는 원리 이해가 더 중요합니다.' },
      { type: 'text', text: '논리적 사고는 수학적 사고력을 측정합니다. 수열, 도형 패턴, 논리 추론 등의 문제가 나옵니다.' },
      { type: 'text', text: '7월부터 시작해 10월까지 16주 동안 체계적으로 학습하면 충분히 준비할 수 있습니다.' },
    ],
  },
]
